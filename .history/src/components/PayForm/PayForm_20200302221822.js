            ...
            <div className='container'>
                ...
                <form className='card-form'>
                    <div className='card-number'>
                        ...
                        <input type="text" name="card-number" placeholder="#### #### #### ####" pattern="[0-9]{10}"/>
                    </div>

                    <div className='expiring'>
                        <label> Термін дії </label><br/>
                        <input type="text" name="card-expiring" placeholder="MM / PP" />
                    </div>

                    <div className='cardholder'>
                        <label> Власник карти </label><ArrowTooltips /> <br/>
                        <input type="text" name="card-expiring" placeholder="CARDHOLDER NAME" />
                    </div>

                    <div className='cvv'>
                        <label> CVV </label><ArrowTooltips /> <br/>
                        <input type="text" name="card-expiring" placeholder="XXX" />
                    </div>
