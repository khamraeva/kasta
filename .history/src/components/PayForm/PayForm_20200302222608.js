            ...
            <div className='container'>
                ...
                <form className='card-form'>
                    ...
                    <div className='expiring'>
                        ...
                        <input type="text" name="card-expiring" placeholder="MM / PP" value={this.state.expiryDate} onChange={this.handleInputChange} />
                    </div>

                    <div className='cardholder'>
                        <label> Власник карти </label><ArrowTooltips /> <br/>
                        <input type="text" name="card-expiring" placeholder="CARDHOLDER NAME" value={this.state.cardholder} onChange={this.handleInputChange} />
                    </div>

                    <div className='cvv'>
                        <label> CVV </label><ArrowTooltips /> <br/>
                        <input type="text" name="card-expiring" placeholder="XXX" value={this.state.cvv} onChange={this.handleInputChange} />
                    </div>
