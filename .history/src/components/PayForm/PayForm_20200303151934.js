    ...
    validateField(name, value) {
        ...
        switch(name) {
            ...
            case 'cardholder':
                ...
                fieldValidationErrors.email = cardholderValid ? '' : ' is invalid';
                break;
                // if (!value.length) {
                //     errors.push({ name, value });
                ...
                // break;
            case 'cvv':
                cvvValid = value.match(/^[0-9]{3}$/)  && typeof value === 'number';
            ...
            case 'expiryDate':
                ...
                fieldValidationErrors.email = expiryDateValid ? '' : ' is invalid';
