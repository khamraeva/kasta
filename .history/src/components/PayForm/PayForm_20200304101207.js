            ...
            <div className='container'>
                ...
                <form className='card-form'>
                    ...
                    <div className='card-number'>
                        <label className='label'> Номер картки </label><br/>
                        <input className='input' type="text" name="cardNumber" placeholder="#### #### #### ####" value={this.state.cardNumber} onChange={this.handleInputChange} /><br/>
                    ...
                    <div className='expiring'>
                        <label className='label'> Термін дії </label><br/>
                        <input className='input' type="text" name="expiryDate" placeholder="MM / PP" value={this.state.expiryDate} onChange={this.handleInputChange} /><br/>
                    ...
                    <div className='cardholder'>
                        <label className='label'> Власник карти </label><ArrowTooltips title={'Фамілія та ім`я людини на яке віпущена картка. Для именних карт - нанесено на карту.'} /> <br/>
                        <input className='input' type="text" name="cardholder" placeholder="CARDHOLDER NAME" value={this.state.cardholder} onChange={this.handleInputChange} /><br/>
                    ...
                    <div className='cvv'>
                        <label className='label'> CVV </label><ArrowTooltips title={'Введить CVV, що на звороті'}/> <br/>
                        <input className='input' type="text" name="cvv" placeholder="XXX" value={this.state.cvv} onChange={this.handleInputChange} /><br/>
