            ...
            <div className='container'>
                ...
                <form className='card-form'>
                    ...
                    <div className='input-container'>
                        ...
                        <input className={classes['form-input'] + ' ' + classes['form-input']} type="text" name="cardNumber" placeholder="#### #### #### ####" value={this.state.cardNumber} onChange={this.handleInputChange} /><br/>
