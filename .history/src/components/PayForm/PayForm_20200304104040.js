            ...
            <div className='container'>
                ...
                <form className='card-form'>
                    ...
                    <div className='input-container'>
                        ...
                        <input className='form-input max-width' type="text" name="cardNumber" placeholder="#### #### #### ####" value={this.state.cardNumber} onChange={this.handleInputChange} /><br/>
                    ...
                    <div className='input-container'>
                        ...
                        <input className='form-input min-width' type="text" name="expiryDate" placeholder="MM / PP" value={this.state.expiryDate} onChange={this.handleInputChange} /><br/>
                    ...
                    <div className='input-container'>
                        ...
                        <input className='form-input max-width' type="text" name="cardholder" placeholder="CARDHOLDER NAME" value={this.state.cardholder} onChange={this.handleInputChange} /><br/>
                    ...
                    <div className='input-container'>
                        ...
                        <input className='form-input min-width' type="text" name="cvv" placeholder="XXX" value={this.state.cvv} onChange={this.handleInputChange} /><br/>
